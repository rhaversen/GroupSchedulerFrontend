	...
	return (
		<div className="relative w-screen h-screen overflow-hidden">
			...
			<Image
				...
				quality={100}
			/>
			<h1 className="font-bold absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 max-w-full text-5xl text-center text-blue-800 whitespace-nowrap">
			...
			<div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex justify-center w-full">
				<Link href="/signup">
					<button className="text-lg font-fredoka font-bold bg-blue-800 text-white py-2.5 px-12 m-2.5 rounded-lg cursor-pointer transition duration-300">
						{'Sign up\r'}
					</button>
				</Link>
				<Link href="/login">
